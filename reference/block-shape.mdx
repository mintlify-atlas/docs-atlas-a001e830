---
title: "Practice Block Schema: Fields and Valid Values"
sidebarTitle: "Block Schema"
description: "Complete field-by-field reference for the CSBP practice block format, including valid values, runtime read order, and a full example block."
---
